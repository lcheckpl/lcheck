			...
			<div className="flex flex-col items-center gap-24 lg:flex-row">
				<div className="flex flex-col gap-6">
					...
					<p className="lead">
						...
						chcesz kupować, jest naprawdę godny zaufania. Skorzystaj
						z lcheck.pl – to portal stworzony specjalnie po to, by
						pomóc Ci sprawdzić, czy dany serwer jest legitny i
						bezpieczny.
					</p>
